...
exports.createReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getReportById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const report = yield DailyReport.findById(req.params.id)
            .populate({
            path: 'activities',
            populate: {
                path: 'civ',
        ...
        const processedReport = Object.assign(Object.assign({}, report.toObject()), { activities: report.activities.map(activity => (Object.assign(Object.assign({}, activity), { fotografia: activity.fotografia ? getFullImagePath(activity.fotografia) : null }))) });
...
exports.updateReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const report = yield DailyReport.findById(req.params.id)
            .populate('createdBy', 'nombre')
            .populate('approvedBy', 'nombre');
        ...
        if (req.body.activities) {
            for (const activity of req.body.activities) {
                yield DailyActivity.findByIdAndUpdate(activity._id, activity, { new: true });
            }
        }
        ...
        const updatedReport = yield DailyReport.findById(report._id)
            .populate('activities')
            .populate('createdBy', 'nombre')
            .populate('approvedBy', 'nombre');
...
exports.deleteReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield DailyReport.findByIdAndDelete(req.params.id);
...
exports.approveReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const populatedReport = yield DailyReport.findById(report._id)
            .populate('createdBy', 'nombre')
            .populate('approvedBy', 'nombre')
            .populate('activities');
...
exports.rejectReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.generateReportPDF = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        yPosition += 20;
        doc.fillColor('black').text(`Creado por: ${((_a = report.createdBy) === null || _a === void 0 ? void 0 : _a.nombre) || 'N/A'}`, 60, yPosition);
        yPosition += 20;
        ...
        if (report.activities && report.activities.length > 0) {
            for (const [index, activity] of report.activities.entries()) {
                try {
                    ...
                    const civData = (_b = activities.find(a => a._id.toString() === activity._id.toString())) === null || _b === void 0 ? void 0 : _b.civ;
                    doc.fontSize(12).fillColor('black');
                    // Add activity image
